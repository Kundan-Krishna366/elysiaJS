...
const Page = () => {
  ...
  return( 
    <div className="flex flex-col h-screen max-h-screen h-dvh max-h-dvh overflow-hidden bg-black text-zinc-100 font-sans selection:bg-white selection:text-black">
      <header className="h-12 sm:h-14 landscape:h-10 border-b border-zinc-900 bg-black/80 backdrop-blur-xl flex items-center justify-between pl-[calc(0.75rem+env(safe-area-inset-left,0px))] pr-[calc(0.75rem+env(safe-area-inset-right,0px))] sm:pl-[calc(1rem+env(safe-area-inset-left,0px))] sm:pr-[calc(1rem+env(safe-area-inset-right,0px))] md:px-6 z-20">
      ...
      <div className="flex-1 overflow-y-auto overscroll-y-contain pt-3 pb-3 sm:pt-4 sm:pb-4 pl-[calc(0.75rem+env(safe-area-inset-left,0px))] pr-[calc(0.75rem+env(safe-area-inset-right,0px))] sm:pl-[calc(1rem+env(safe-area-inset-left,0px))] sm:pr-[calc(1rem+env(safe-area-inset-right,0px))] md:px-6 md:py-6 bg-black relative">
      ...
      <footer className="bg-black border-t border-zinc-900 pt-2.5 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))] pl-[calc(0.75rem+env(safe-area-inset-left,0px))] pr-[calc(0.75rem+env(safe-area-inset-right,0px))] sm:pt-4 sm:pb-[calc(1rem+env(safe-area-inset-bottom,0px))] sm:px-6 landscape:pt-1.5 landscape:pb-[calc(0.5rem+env(safe-area-inset-bottom,0px))] z-20">
